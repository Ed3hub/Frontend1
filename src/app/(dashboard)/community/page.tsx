...
const Community = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className=" mb-8">
        <div className="w-full flex items-center space-x-4 mb-6 pl-6">
          <div className="relative">
            <input
              type="text"
              placeholder="Search Communities"
              className="w-96 px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
        </div>
        
        <p className="text-muted-foreground mb-6 pl-6 ">
