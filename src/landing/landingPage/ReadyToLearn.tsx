    ...
    <div className="">
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="bg-[#fff hover:bg-[#ffffffcb] text-white border-2 border-blue-300 px-10 py-5 rounded-xl font-black text-lg hover:bg-blue-400 transition-all">
            View Pricing
          </button>
        </div>
      </div>
