      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-left duration-700">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight tracking-tight">
            ...
            Build proof.
            <br />
            <span className="text-[#0077b6]">Unlock opportunities.</span>
          </h1>

          {/* Subtext */}
          <p className="text-slate-600 text-lg max-w-lg leading-relaxed">
            Expert-led learning paths with projects, community, and outcomes
          ...
          {/* <div className="flex flex-wrap items-center gap-6 pt-8 text-slate-500 text-sm font-medium">
            ...
            <div className="flex items-center gap-2">
              <GraduationCap size={18} className="text-[#0077b6]" /> 500+
              Courses
            </div>
            <div className="flex items-center gap-2">
